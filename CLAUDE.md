...
The wiki exists so Claude Code does not repeatedly rediscover the same facts, reintroduce old bugs, or make broad changes without understanding the project history.
...
5. Never overwrite project rules already defined in this CLAUDE.md.
